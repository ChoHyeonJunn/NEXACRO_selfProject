if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("uiadapter17", "form", "./uiadapter17/", "session", null, "", "0", "0");
        ...
        nexacro._addService("rChart", "form", "./rChart/", "session", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"TowMonthCalendar", "classname":"nexacro.TowMonthCalendar", "type":"JavaScript"}
        ];
